...
CatBreedsImage catBreedsImageFromJson(String str) =>
    CatBreedsImage.fromJson(json.decode(str));

String catBreedsImageToJson(CatBreedsImage data) => json.encode(data.toJson());

class CatBreedsImage {
  String? id;
  String? url;
  List<Breed> breeds;
  int? width;
  ...
  factory CatBreedsImage.fromJson(Map<String, dynamic> json) => CatBreedsImage(
        id: json["id"],
        url: json["url"],
